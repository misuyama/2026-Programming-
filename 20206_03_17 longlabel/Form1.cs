...
namespace _20206_03_17_longlabel
{
    public partial class Form1 : Form
    {
        ...
        {
            //string zip1 = "잔 다르크(프랑스어: Jeanne d'Arc, 문화어: 쟝느 다르크, 1412년 1월 6일 ~ 1431년 5월 30일)는 백년 전쟁에서 활약한 프랑스의 수호성인이다. 오를레앙의 처녀(la Pucelle d’Orléans)라고도 불린다.";
            //string zip2 =
            //     "영국과 프랑스 간의 백년 전쟁이 진행 중이던 1412년 프랑스 북동부 지방 동레미에서 농부의 딸로 태어났다.\n " +
            ...
            // label1.Text = zip1;
            // longlabel.Text = zip2;
            label1.Text = "잔 다르크(프랑스어: Jeanne d'Arc, 문화어: 쟝느 다르크, 1412년 1월 6일 ~ 1431년 5월 30일)는 백년 전쟁에서 활약한 프랑스의 수호성인이다. 오를레앙의 처녀(la Pucelle d’Orléans)라고도 불린다.";
